...
import cn.edu.suda.ada.ect.types.*;
...
import static cn.edu.suda.ada.ect.storage.IcebergUtils.writeTrajectorySegment;

public class AssemblerActorImpl extends ECTActor implements AssemblerActor {
