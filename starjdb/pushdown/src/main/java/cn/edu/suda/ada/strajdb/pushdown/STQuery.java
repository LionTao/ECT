...
public class STQuery {
    ...
    public static void main(String[] args) throws IOException {
        ...
        float minX=116.41023f;
        float minY=39.91392f;
        float maxX=117.08973f;
        float maxY=40.18148f;
        ...
        writeCSV(csvResult, "pushdown-st-hdfs.csv");
        ...
        writeCSV(csvResult, "pushdown-st-oss-plain.csv");
        csvResult = new LinkedList<>();
        // our
        ...
        writeCSV(csvResult, "pushdown-st-pushdown.csv");
        ...
        writeCSV(csvResult, "pushdown-st-pushdown-delta.csv");
