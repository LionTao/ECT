            ...
            for(String gridID: lineString.gridIDsSet) {
                if (neighboringCells.contains(gridID)) {
                    outputLineString = new LineString(
                            lineString.objID, new ArrayList<>(Arrays.asList(lineString.lineString.getCoordinates())),
                            lineString.gridIDsSet, gridID, lineString.timeStampMillisec,lineString.boundingBox);
