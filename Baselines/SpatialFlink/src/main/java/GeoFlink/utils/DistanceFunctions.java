...
public class DistanceFunctions {
    ...
    // ADDED DTW
    public static double getDTWDistance(LineString obj1, LineString obj2, UniformGrid uGrid) {
        return TrajectoryDistance.DTW(obj1, obj2, uGrid);
    }

    public static double getFrechetDistance(LineString obj1, LineString obj2) {
        return TrajectoryDistance.Frechet(obj1, obj2);
    }
